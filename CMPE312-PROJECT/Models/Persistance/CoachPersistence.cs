...
namespace CMPE312_PROJECT.Models.Persistance
{
    public class CoachPersistence
    {
        ...
        {
            string sqlQuery = "select * from COACH where NAME='" + coach1.name + "'"; 
        ...
        public static bool AddCoach(Coach coach1)
        {
           /* System.Diagnostics.Debug.WriteLine("DateTime: " + coach1.birthDate.ToString("yyyy-MM-dd"));
            ...
            if (rows1.Count == 0)
            {
                string sql2 = "Insert into COACH (ID, NAME, SURNAME, BIRTH_DATE, SALARY, TEAM_ID) values ('" + 1 + "','" + coach1.name + "','" + coach1.surname + "','" + coach1.birthDate + "','" + coach1.salary + "','" + coach1 .teamID + "')";
            ...
            else
            {
                ...
                string sql4 = "Insert into COACH (ID, NAME, SURNAME, BIRTH_DATE, SALARY, TEAM_ID) values ('" + NewId + "','" + coach1.name + "','" + coach1.surname + "','" + coach1.birthDate + "','" + coach1.salary + "','" + coach1.teamID + "')";
