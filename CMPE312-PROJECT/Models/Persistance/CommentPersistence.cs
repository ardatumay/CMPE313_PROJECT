...
namespace CMPE312_PROJECT.Models.Persistance
{
    public class CommentPersistence
    {
        public static bool addComment(Comment comment)
        {
            ...
            if (rows1.Count == 0)
            {
                string sql2 = "Insert into COMMENT (ID, COMMENT, PLAYER_ID, COACH_ID, PRESIDENT_ID, TEAM_ID) values ('" + 1 + "','" + comment.comment + "','" + 0 + "','" + 0 + "','" + 0 + "','" + comment.teamID + "')";
            ...
            else
            {
                ...
                string sql4 = "Insert into COMMENT (ID, COMMENT, PLAYER_ID, COACH_ID, PRESIDENT_ID, TEAM_ID) values ('" + NewId + "','" + comment.comment + "','" + 0 + "','" + 0 + "','" + 0 + "','" + comment.teamID + "')";
